...
mp.events.add("render", () => {
    if (streetName && zoneName) {
        drawText(streetName, [minimap.rightX + 0.03, minimap.bottomY - 0.060], 4, [255, 255, 255, 255], 0.55);
        drawText(zoneName, [minimap.rightX + 0.03, minimap.bottomY - 0.030], 4, [255, 255, 255, 255], 0.5);
